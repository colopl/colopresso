...
const bundle: TranslationBundle = {
  ...
  messages: {
    ...
    settingsMenu: {
      ...
      resetSuccess: 'All settings were reset. Restarting the application.',
    ...
    settingsModal: {
      ...
      alerts: {
        ...
        reloadRequired: 'This setting change requires restarting the application to take effect. Do you want to restart now?',
        reloadRequiredTitle: 'Restart Required',
        reloadRequiredWarning: 'Requires application restart to take effect',
      },
      prompts: {
