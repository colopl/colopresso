...
const bundle: TranslationBundle = {
  ...
  messages: {
    ...
    settingsMenu: {
      ...
      resetSuccess: 'すべての設定をリセットしました。アプリケーションを再起動します。',
    ...
    settingsModal: {
      ...
      alerts: {
        ...
        reloadRequired: 'この設定変更を反映するにはアプリケーションの再起動が必要です。今すぐ再起動しますか？',
        reloadRequiredTitle: '再起動が必要',
        reloadRequiredWarning: '設定の反映にはアプリケーションの再起動が必要です',
      },
      prompts: {
    ...
    common: {
      ...
      conversionCanceled: '変換がキャンセルされました',
    ...
    errors: {
      outputLarger: '変換エラー: {format} の出力サイズが入力より大きいか同じになりました (入力 {inputSize}, 出力 {outputSize})。',
      sizeUnknown: 'サイズ不明',
    ...
    formats: {
      ...
      pngx: {
        name: 'PNG',
        sections: {
          palette256: '256 色パレット減色詳細チューニング',
        },
        fields: {
          level: '最適化レベル (0-6)',
          strip_safe: '安全チャンク除去',
          ...
          palette256_gradient_dither_floor: 'グラデーション ディザ下限',
          ...
          palette256_profile_opaque_ratio_threshold: '不透明率しきい値',
          palette256_profile_gradient_mean_max: '勾配平均最大',
          palette256_profile_saturation_mean_max: '彩度平均最大',
          palette256_tune_opaque_ratio_threshold: '不透明率しきい値',
          palette256_tune_gradient_mean_max: '勾配平均最大',
          palette256_tune_saturation_mean_max: '彩度平均最大',
          palette256_tune_speed_max: '速度上限',
          palette256_tune_quality_min_floor: '最小品質下限',
          palette256_tune_quality_max_target: '最大品質目標',
        },
        options: {
          lossy_type: {
            palette256: '256 色パレット',
